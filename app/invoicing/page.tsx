                    ...
                    <div className="col-lg-12">
                        ...
                        <div className="row ">
                            <div className="col-lg-4 mb-4 ">
                                <div className=" p-4 bg-[#F3EFE7] border rounded-4 shadow-sm  h-full flex-1 ">
                                    ...
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[150px] overflow-hidden">Effortlessly connect your sales platforms and bank accounts to access real-time data, returns, and fees. This gives you the insights needed to make informed, smarter business decisions.</p>
                            ...
                            <div className="col-lg-4 mb-4">
                                <div className=" p-4 bg-[#F3EFE7] border  relative rounded-4 shadow-sm flex-1 h-full">
                                    <div className="lg:pt-[20px] pt-[10px]">
                                    ...
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[150px] overflow-hidden">Your dedicated accountant will fully understand your business, helping you manage taxes, VAT reports, and more, ensuring your finances are always in order.</p>
                                    <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                </div>
                            </div>
                            <div className="col-lg-4 mb-4">
                                <div className="flex-1 h-full relative p-4 bg-[#F3EFE7] border  rounded-4 shadow-sm  ">
                                    <div className="lg:pt-[20px] pt-[10px]">
                                    ...
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[150px] overflow-hidden">Automate your bookkeeping across all sales platforms, relying on an expert accountant who specialises in ecommerce to keep your financials on track.</p>
                                    <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row justify-center">
                            <div className="col-lg-4 mb-4 ">
                                <div className=" p-4 bg-[#F3EFE7] border rounded-4 shadow-sm flex-1 h-full">
                                    ...
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[150px] overflow-hidden">Get clear and actionable insights into how your business is performing. This allows you to take steps to improve and increase profitability.</p>
                                    <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                </div>
                            </div>
                            <div className="col-lg-4 mb-4 ">
                            ...
                            <div className="col-lg-4 mb-4">
                                <div className=" p-4 bg-[#F3EFE7] border rounded-4 shadow-sm flex-1 h-full">
                                    ...
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[150px] overflow-hidden">Track bills and receipts, and gain full control over due dates and payments.</p>
                                    <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-9">
                                ...
                                <Accordion type="single" collapsible>
                                                ...
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                                            ...
                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  rounded-4 ">Cloud BSS is a comprehensive platform offering tailored financial management tools, accounting services, and expert advice designed to help small businesses streamline their financial processes, stay compliant, and maximize growth.
                                    ...
                                    <AccordionItem value="item-2">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">How does Cloud BSS help with company registration?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                    ...
                                    <AccordionItem value="item-3">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0  ">What are the benefits of using Cloud BSS for bookkeeping?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833] ">Cloud BSS includes unlimited bookkeeping in your plan. Our software automatically matches transactions, helps prepare tax records, and ensures compliance, while your dedicated accountant is always available to offer expert guidance.
                                    ...
                                    <AccordionItem value="item-4">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">Can Cloud BSS handle VAT and tax filings?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  ">Yes! We track tax deadlines, manage VAT filings, and ensure you&apos;re paying the right amount of tax. Your accountant will handle all the required filings, saving you time and minimising the risk of penalties.
                                    ...
                                    <AccordionItem value="item-5">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">What platforms can Cloud BSS integrate with for ecommerce?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  ">Cloud BSS integrates with major ecommerce platforms like Amazon, Shopify, and eBay, as well as payment gateways like PayPal and Stripe. These integrations automate your bookkeeping and ensure all your financial data stays in sync.
                                    ...
                                    <AccordionItem value="item-6">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0  ">How does Cloud BSS support property owners and landlords?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  ">We specialise in property accounting, providing support to buy-to-let landlords, property developers, property flippers, and serviced accommodation owners. We help optimize tax deductions, ensure compliance, and manage property-specific finances.
                                    ...
                                    <AccordionItem value="item-7">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">How do I contact Cloud BSS for support?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  ">You can contact us at any time via live chat or phone. Our dedicated accountants are available to answer your questions and provide personalised guidance for your business.
                                    ...
                                    <AccordionItem value="item-8">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">Can Cloud BSS help me understand and manage my cash flow?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833] ">Absolutely! Our software provides a real-time snapshot of your cash flow, allowing you to stay on top of your finances and make more informed decisions. Your dedicated accountant will always be available to offer advice based on this data.
                                    ...
                                    <AccordionItem value="item-9">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4  shadow-md ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">How does Cloud BSS help with cash flow?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833] ">Our pricing plans are flexible and customizable to fit your needs. Whether you&apos;re just starting or running an established business, you can choose a plan that suits your stage. All plans include bookkeeping, tax filing, and expert accounting support.
