                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="col-lg-9 ">
                                        <p className="font-semibold lg:text-[2.8vw] text-[4.5vw] lg:leading-[3.2vw] leading-[5.5vw] lg:pt-[130px] pt-[30px] text-[#212833]">Professional Accountants Based in London</p>
                                        <p className="text-[#232323] lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] lg:pt-[20px] pt-[10px] ">
                                        Access premium accounting services in London to help your business grow. Cloud BSS combines expert professionals with intuitive software to keep you on top of tax deadlines and financial management.</p>
                    ...
                    <div className="col-lg-12">
                        <div className="flex justify-center">
                            <div className="col-lg-4 ">
                                ...
                                <p className="lg:text-[1.8vw] text-[4.5vw] lg:leading-[2.5vw] leading-[5.5vw] text-center font-bold lg:pb-[50px] pb-[20px]">Full oversight and control of your finances.</p>
                            </div>
                        </div>
                        <div className="row ">
                            ...
                            <div className="col-lg-3 mb-4">
                                <div className="block  p-6 bg-white border border-white rounded-4 shadow-sm lg:h-[430px] ">
                                    ...
                                    <p className="lg:text-[1.5vw] text-[4vw] lg:leading-[2vw] leading-[5vw] font-medium lg:pt-[30px] pt-[20px]">Unlimited accounting support</p>
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:pb-[58px] pb-[20px]">Bookkeeping is included in your package. We handle your financial records, taxes, transaction matching, and billing for you.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 mb-4 ">
                                <div className="block  p-6 bg-white border border-white rounded-4 shadow-sm lg:h-[430px] ">
                    ...
                    <div className="col-lg-12">
                        <div className="flex justify-center">
                            <div className="col-lg-4 ">
                                ...
                                <p className=" text-[#353535] lg:text-[1.8vw] text-[4.5vw] lg:leading-[2.5vw] leading-[5.5vw] text-center font-bold lg:pb-[50px] pb-[20px]">Ideal for both aspiring founders and seasoned entrepreneurs.</p>
                            </div>
                        </div>
                        <div className="row ">
                    ...
                    <div className="col-lg-12 lg:text-[1vw] text-[2vw] lg:leading-[1vw] leading-[3vw] lg:pt-[80px] pt-[60px] sm:pb-[50px] pb-[10px] text-center ">
                        <div className="flex justify-center ">
                            <div className="col-lg-4">
                                ...
                                <p className="lg:text-[1.8vw] text-[4.5vw] lg:leading-[2.5vw] leading-[5.5vw] text-center font-bold text-[#353535] lg:pb-[20px] pb-[20px] ">A comprehensive solution for small business accounting</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-10 lg:pt-[20px] pt-[10px]">
                        <div className="row ">
                            <div className="col-lg-6">
                            ...
                            <div className="col-lg-6 lg:pt-[160px] pt-[20px]">
                                <div className="flex lg:justify-end">
                                    <div className="col-lg-9">
                                        <p className="text-[#010202]   font-semibold lg:text-[2vw] text-[4vw] lg:leading-[2.5vw] leading-[5vw] ">Expert accountants based in London</p>
                                        <p className="text-[#000]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">From day one, you’ll have a dedicated accountant for your small business. Our London-based experts help entrepreneurs navigate taxes seamlessly. Have questions? Get answers within 24 hours via live chat.
                                        </p>
                                    </div>
                            ...
                            <div className="row ">
                                <div className="col-lg-6 lg:pt-[160px] pt-[20px] order-lg-1 order-2">
                                    <div className="flex lg:justify">
                                        <div className="col-lg-9 ">
                                            <p className="text-[#010202]   font-semibold lg:text-[2vw] text-[4vw] lg:leading-[2.5vw] leading-[5vw] ">Achieve clear insights into your cash flow.</p>
                                            <p className="text-[#000]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">Our real-time dashboard keeps your small business’s cash flow at your fingertips. Instantly see your available funds, upcoming payments, and outstanding invoices at a glance.
                                            </p>
                                        </div>
                    ...
                    <div className="col-md-10 lg:pt-[80px] pt-[40px]">
                        <div className="row ">
                            ...
                            <div className="col-lg-6 lg:pt-[160px] pt-[20px]">
                                <div className="flex lg:justify-end">
                                    <div className="col-lg-9 ">
                                        <p className="text-[#010202]   font-semibold lg:text-[2vw] text-[4vw] lg:leading-[2.5vw] leading-[5vw] ">Tax-efficient accounting solutions</p>
                                        <p className="text-[#000]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">Our London accountants ensure you pay the right tax throughout the year, keeping track of deadlines and reminding you of VAT and compliance requirements. We handle the admin, so you can focus on growing your business.
                                        </p>
