                        ...
                        <div className="row justify-end">
                            <div className="col-lg-3 mb-4 ">
                                <div className="block  p-1 bg-[#F3EFE7]  rounded-4   ">
                                    <div className="block  p-6 bg-[#FFFDFA]  rounded-4  lg:h-[320px] ">
                                        <p className="lg:text-[1.5vw] text-[4vw] lg:leading-[1vw] leading-[5vw] font-medium lg:pt-[10px] pt-[5px]">Basic for residents</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pb-[20px] pb-[0px]">Set up as a limited company and receive all legal paperwork</p>
                            ...
                            <div className="col-lg-3 mb-4 ">
                                <div className="block  p-1 bg-[#F3EFE7]  rounded-4   ">
                                    <div className="block  p-6 bg-[#FFFDFA]  rounded-4 lg:h-[320px]  ">
                                        ...
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161]">Register a limited company and get all needed compliance</p>
                            ...
                            <div className="col-lg-3 mb-4 ">
                                <div className="flex justify-center">
                                    <div className="col-lg-10">
                                        ...
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Company formation , including £50 Companies House fee</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Live chat with an expert</p>
                                        ...
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Exclusive offers from our Banking Partners</p>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-3 mb-4 ">
                                <div className=" flex justify-center items-center p-1 bg-[#F3EFE7]  rounded-4  lg:pt-[20px] pt-[10px] lg:pb-[20px] pb-[10px] lg:h-[350px]  ">
                                    <div className="items-center justify-center">
                                        ...
                                        <div className="lg:pt-[30px] pt-[10px] " >
                                            <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw] font-medium p-0 m-0">1 Year</p>
                                        </div>
                                        <div className="lg:pt-[30px] pt-[10px] " >
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="" color="#000000" fill="none">
                                                <path d="M5 14L8.5 17.5L19 6.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            ...
                            <div className="col-lg-3 mb-4 ">
                                <div className="flex justify-center">
                                    <div className="col-lg-10">
                                        ...
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Digital incorporation certificates</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Share Certificate</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Same-day document scanning</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Manual document review</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Confirmation Statement</p>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-3 mb-4 ">
                                <div className=" flex justify-center p-1 bg-[#F3EFE7]  rounded-4   lg:h-[400px] items-center ">
                                    <div >
                                        ...
                                        <div className="lg:pt-[30px] pt-[10px] " >
                                            <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw] font-medium p-0 m-0">£49</p>
                                        </div>
                                        <div className="lg:pt-[30px] pt-[10px] " >
                            ...
                            <div className="col-lg-3 mb-4 ">
                                <div className="flex justify-center">
                                    <div className="col-lg-10">
                                        ...
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">VAT registration</p>
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.3vw] leading-[4vw]  text-[#616161] lg:pt-[20px] pt-[10px]">Accounting services</p>
                                    </div>
                                </div>
