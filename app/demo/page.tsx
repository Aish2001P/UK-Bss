                ...
                <div className="col-lg-12">
                        ...
                        <div className="row ">
                            <div className="col-lg-4 mb-4 ">
                                <div className="p-4 bg-[#FFFDFA] border rounded-4 shadow-sm flex-1 h-full ">
                                    ...
                                    <div className="lg:h-[300px] ">
                                        ...
                                        <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Effortlessly connect your marketplaces, payment systems, and bank accounts to gain real-time visibility into your sales, returns, and fees. This allows you to make smarter, data-driven decisions that drive your business forward.</p>
                            ...
                            <div className="col-lg-4 mb-4">
                                <div className="p-4 bg-[#FFFDFA] border rounded-4 shadow-sm flex-1 h-full  ">
                                    <div className="lg:pt-[20px] pt-[10px]">
                                        <Image className="img-responsive w-28 " src="/Images/copy2.svg" alt="logo" width={1830} height={750} />
                                    </div>
                                    <div className="lg:h-[300px] ">
                                        <p className="lg:text-[1.5vw] text-[4vw] lg:leading-[2vw] leading-[5vw] font-medium lg:pt-[30px] pt-[20px]"> Accounting</p>
                                        <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Let Cloud BSS handle the complexities of financial management. Your dedicated accountant will understand your business inside and out, managing your taxes, VAT reports, and ensuring your finances are always in perfect order.</p>
                                        <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 mb-4">
                                <div className="p-4 bg-[#FFFDFA] border  rounded-4 shadow-sm flex-1 h-full  ">
                                    <div className="lg:pt-[20px] pt-[10px]">
                                        <Image className="img-responsive w-28 " src="/Images/copy3.svg" alt="logo" width={1830} height={750} />
                                    </div>
                                    <div className="lg:h-[300px]">
                                    <p className="lg:text-[1.5vw] text-[4vw] lg:leading-[2vw] leading-[5vw] font-medium lg:pt-[30px] pt-[20px]">Ecommerce Expertise</p>
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Automate your bookkeeping across multiple sales platforms. Our team specializes in ecommerce accounting, allowing you to focus on scaling your business while we handle your financials with care and precision.</p>
                                    <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row ">
                            <div className="col-lg-4 mb-4 ">
                                <div className="p-4 bg-[#FFFDFA] border rounded-4 shadow-sm  flex-1 h-full ">
                                    ...
                                    <div className="lg:h-[300px] ">
                                        ...
                                        <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Capture bills, receipts, and have a complete control over what’s due and when.</p>
                                        <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 mb-4">
                                <div className="p-4 bg-[#FFFDFA] border rounded-4 shadow-sm flex-1 h-full  ">
                                    ...
                                    <div className="lg:h-[300px] ">
                                        ...
                                        <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Keep track of your expenses and ensure compliance when reporting your personal expenditures.</p>
                                        <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 mb-4">
                                <div className="p-4 bg-[#FFFDFA] border  rounded-4 shadow-sm flex-1 h-full  ">
                                    ...
                                    <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Stay in control of your cash flow by creating and sending professional invoices with ease. Track outstanding payments and get paid faster with integrated payment options like PayPal.</p>
                                    <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 mb-4 ">
                                <div className="p-4 bg-[#FFFDFA] border rounded-4 shadow-sm  flex-1 h-full ">
                                    ...
                                    <div className="lg:h-[300px] ">
                                        ...
                                        <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium text-[#616161] lg:h-[170px] overflow-hidden">Monitor your business performance in real-time. Cloud BSS delivers clear, actionable reports on your revenue, expenses, and profitability, empowering you to make informed decisions that lead to growth.</p>
                                        <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 text-center items-center">Learn more</button>
                                    </div>
                                </div>
                            </div>
