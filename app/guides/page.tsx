...
export default function Home() {
    ...
    return (
        < >
                        ...
                        <div className="lg:pb-[20px] pb-[20px]">
                            ...
                            <div className="flex justify-center">
                                <div className="col-lg-6 ">
                                    <p className="font-semibold lg:text-[3vw] text-[4.5vw] lg:leading-[3.5vw] leading-[5.5vw] text-center lg:pt-[130px] pt-[30px] text-[#212833]">Business Guides on Running a Company in the United Kingdom</p>
                                    <p className="text-[#232323] lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] text-center lg:pt-[20px] pt-[10px] ">
                                    Osome Guides provide you with everything you need to know about running a company in the UK: checklists, roadmaps, and explanation of bureaucratic rules.</p>
                                </div>
                            </div>
                                ...
                                <div className="col-lg-10">
                                    <div className=" lg:flex gap-4 lg:pb-[60px] pb-[50px] justify-center items-center ">
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-4 py-2 text-center items-center">Starting a Company</button>
                                        </div>
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-4 py-2 text-center items-center">Bookkeeping</button>
                                        </div>
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-4 py-2 text-center items-center">Running a Business</button>
                                        </div>
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-3 py-2 text-center items-center">TAX & VAT</button>
                                        </div>
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-3 py-2 text-center items-center">Ecommerce</button>
                                        </div>
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-4 py-2 text-center items-center">Grow a Business</button>
                                        </div>
                                        <div className="lg:pb-[0px] pb-[20px]">
                                            <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full sm: w-full text-sm px-4 py-2 text-center items-center">Guides</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="lg:px-[100px] px-[20px] lg:pt-[20px] pt-[20px] overflow-hidden bg-[#F3EFE7]">
                                ...
                                <div className="col-lg-10 ">
                                    <div className="row ">
                                        <div className="col-lg-8 mb-4 ">
                                            <div className="block relative  bg-[#FFF] border rounded-4 shadow-sm    ">
                                                <div className="relative">
                                                    <Image className="img-responsive w-full " src="/Images/i5.png" alt="logo" width={1830} height={750} />
                                                </div>
                                                <div className="absolute bottom-[10%]">
                                                    ...
                                                    <p className="text-[#000]  lg:text-[2vw] text-[3vw] lg:leading-[2.5vw] leading-[4vw] lg:pb-[20px] pb-[20px] font-medium lg:pl-[40px] pl-[10px]">Setting Up An Offshore Company in the UK</p>
