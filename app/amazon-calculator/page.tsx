                                                ...
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                                            ...
                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  lg:pl-[25px] pl-[5px] text-[#212833]  ">By analyzing product costs, sellers can determine their profit margin, a key performance indicator (KPI). Profit margin represents the difference between revenue and expenses and is calculated as profit divided by sales, expressed as a percentage.
                                                            </p>
                                                ...
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                                            ...
                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  lg:pl-[25px] pl-[5px] text-[#212833]  ">Amazon seller fees depend on factors like product category, selling plan (Individual or Professional), and fulfillment method (FBA or FBM). Typically, sellers incur referral fees, closing fees, and potentially other charges based on their specific selling conditions.
                                                            </p>
