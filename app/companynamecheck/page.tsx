                    ...
                    <div className="col-lg-12">
                        ...
                        <div className="flex justify-center">
                            <div className="col-lg-4 ">
                                ...
                                <p className=" text-[#353535] lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]  text-center  lg:pb-[30px] pb-[20px]">When choosing a name for your business, keep these important points in mind to ensure it complies with UK regulations:</p>
                            </div>
                        </div>
                        <div className="col-lg-12">
                            <div className="flex justify-center">
                                                    ...
                                                    <AccordionItem value="item-1">
                                                        <AccordionTrigger>
                                                            <div className="flex items-center p-0 m-0">
                                                                ...
                                                                <p className="lg:text-[1.2vw] text-[4vw] lg:leading-[1vw] leading-[5vw]  lg:pl-[15px] pl-[5px] text-[#212833] m-0">
                                                                    Unique </p>
                                                            </div>
                        ...
                        <div className="row justify-center">
                            <div className="col-lg-4 mb-4 ">
                                <div className="block  p-1 bg-[#FFF]  rounded-4   ">
                                    <div className=" p-6 bg-[#F3EFE7]  rounded-4 flex-1 h-full  ">
                                    ...
                                    <div className="lg:pl-[25px] pl-[10px] lg:pt-[30px] pt-[30px] font-medium">
                                        <p className="lg:text-[1vw] text-[3.4vw] lg:leading-[1.7vw] leading-[3.5vw] ">
                                            <p className="lg:text-[1vw] text-[4vw] lg:leading-[1.1vw] leading-[5vw] font-semibold ">Setting up</p>
                                            ...
                                            <p className="lg:text-[1vw] text-[4vw] lg:leading-[1.1vw] leading-[5vw] font-semibold lg:pt-[30px] pt-[20px]">Documents</p>
                                            <div className="flex gap-2">
                                                <div className="p-0 m-0" >
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="" color="#000000" fill="none">
                                                        <path d="M5 14L8.5 17.5L19 6.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <div className="block  p-1 bg-[#FFF] rounded-4 shadow-sm  ">
                                    <div className=" p-6 bg-[#F3EFE7]  rounded-4 flex-1 h-full  ">
                                        <div className="lg:h-[250px] overflow-hidden">
                                            ...
                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1vw] leading-[3vw] font-semibold m-0 p-0 line-through">£299</p>
                                ...
                                <div className="block  p-1 bg-[#FFF] rounded-4 shadow-sm  ">
                                    <div className=" p-6 bg-[#F3EFE7]  rounded-4 flex-1 h-full  ">
                                        <div className="lg:h-[250px] overflow-hidden">
                                            ...
                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1vw] leading-[3vw] font-semibold m-0 p-0 line-through">£349</p>
                            ...
                            <div className="col-lg-9">
                                ...
                                <Accordion type="single" collapsible>
                                    <AccordionItem value="item-1">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0">What is the Company Name Check Tool?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                    ...
                                    <AccordionItem value="item-2">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px]  p-0 m-0">How does the Business Name Check Tool work?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833] "> Simply enter your preferred name into the tool, and we’ll check it against the Companies House database. If the name is available, you can proceed with registration.
                                    ...
                                    <AccordionItem value="item-3">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px]  p-0 m-0">Why should I check the availability of a company name in the UK?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  "> It's important to check your company name to ensure it’s unique and meets regulatory requirements. You can't use a name already registered with Companies House, so checking availability prevents delays.
                                    ...
                                    <AccordionItem value="item-4">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px]  p-0 m-0">What are the criteria for a valid company name in the UK?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  ">  A valid name must be unique, non-offensive, non-sensitive, and typically include "Limited" or "Ltd." for private limited companies (with some exceptions, like charities).
                                                            </p>
                                    ...
                                    <AccordionItem value="item-5">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px]  p-0 m-0 ">What should I do if my desired company name is already taken?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  "> If your name is already taken, you'll need to choose a new one. Our Company Name Check Tool offers suggestions to help you find an alternative.
                                                            </p>
                                    ...
                                    <AccordionItem value="item-6">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw] font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px]  p-0 m-0">How can I reserve a company name once it’s available?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]   text-[#212833]  "> If the name is available, we’ll assist you in reserving it with Companies House during the registration process.
