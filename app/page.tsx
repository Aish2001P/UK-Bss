  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-lg-4 mb-4 ">
              <div className="flex-1 h-full p-6 bg-white border border-white rounded-4 shadow-sm  ">
                ...
                <div className="">
                <Link href="/Accountingservices" className="text-black" ><button type="button" className="border border-dark  hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm w-full py-1 text-center items-center">Go to Accounting</button></Link>
                </div>
            ...
            <div className="col-lg-4  mb-4 ">
              <div className="flex-1 h-full  p-6 bg-white border border-white rounded-4 shadow-sm  ">
                ...
                <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm w-full py-1 me-2 mb-2">Go to Ecommerce</button></Link>
            ...
            <div className="col-lg-4 mb-4">
              ...
              <div className=" lg:h-[230px] overflow-hidden">
               ...
               <Link href="/Registeracompany" className="text-black">
                <button type="button" className="border border-dark  hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm w-full py-1 text-center items-center">Go to Incorporation</button></Link>
      ...
      <section className="lg:px-[100px] px-[20px]  ">
        <div className="row justify-center">
          <div className="col-lg-12 lg:text-[1vw] text-[2vw] lg:leading-[1vw] leading-[3vw] lg:pt-[80px] pt-[30px] sm:pb-[10px] pb-[10px] text-center ">
            <div className="flex justify-center ">
      ...
      <section className="lg:px-[120px] px-[20px] overflow-hidden">
        <div className="row  justify-center ">
          <div className="col-lg-10 ">
            <div className="lg:pt-[50px] pt-[10px]">
              <div className="row items-center">
