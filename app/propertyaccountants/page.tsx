...
export default function Home() {
    ...
    return (
        <>
                            ...
                            <div className="row items-center">
                                <div className="col-lg-6">
                                    <div className="col-lg-10">
                                        <p className="font-semibold lg:text-[2.8vw] text-[4.5vw] lg:leading-[3.2vw] leading-[5.5vw] lg:pt-[0px] pt-[30px] text-[#212833]">Expert Property Accountants for Your UK Portfolio</p>
                                        ...
                                        <div className=" lg:flex gap-4 lg:pb-[0px] pb-[50px]">
                                            ...
                                            <div>  <Link href="/accountingprices" className="text-black">
                                                <button type="button" className="border border-dark hover:bg-[#000] hover:text-[#fff] font-medium !rounded-full text-sm px-5 py-2 sm: w-full text-center items-center">Pricing</button></Link>
                                            </div>
                                        </div>
            ...
            <section className="lg:px-[100px] px-[20px] lg:pt-[50px] pt-[30px] overflow-hidden  bg-[#000]">
                <div className="row ">
                    <div className="col-lg-12 ">
                        <div className="row items-end">
                            ...
                            <div className="col-lg-9">
                                ...
                                <Accordion type="single" collapsible>
                                    ...
                                    <AccordionItem value="item-2">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">How can Cloud BSS help with property taxes?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                    ...
                                    <AccordionItem value="item-3">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">Is bookkeeping included in the service?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  text-[#212833] ">Yes, bookkeeping is included in all our plans. We take care of your financial records, ensuring everything is accurate and up-to-date so you can focus on growing your property portfolio.
                                    ...
                                    <AccordionItem value="item-4">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">What kind of accounting software does Cloud BSS provide?
                                                </p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  text-[#212833]  ">We offer simple, easy-to-use accounting software that centralises your finances in one place. You can track cash flow, manage your property income, and communicate directly with your accountant—all through a user-friendly app.
                                    ...
                                    <AccordionItem value="item-5">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">Do I need to set up a limited company to benefit from Cloud BSS?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  text-[#212833]  ">Not necessarily. While setting up a limited company can offer specific benefits for property investments, it's not a requirement to use our services. Our accountants provide tailored advice to determine if a limited company structure is right for you.
                                                ...
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">
                                                            ...
                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  text-[#212833]  ">Simply choose your plan and schedule a call with one of our experts. We&apos;ll guide you through the process, offering tailored services based on your unique needs.
                                    ...
                                    <AccordionItem value="item-7">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">Is there ongoing support for compliance?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  text-[#212833]  ">Yes, our team ensures your property business stays compliant with tax laws and deadlines. We handle all your filings and tax obligations, so you never have to worry about missing deadlines.
                                    ...
                                    <AccordionItem value="item-8">
                                        <div className="col-lg-12 mb-4">
                                            <div className="block  p-6 bg-white border border-white rounded-4   ">
                                                <AccordionTrigger> <p className=" lg:text-[1.2vw] text-[3vw] lg:leading-[1.5vw] leading-[3vw]font-medium lg:pt-[20px] pt-[10px] lg:pl-[20px] pl-[5px] p-0 m-0 ">Can I customize my plan as my business grows?</p></AccordionTrigger>
                                                <AccordionContent>
                                                    <div className="lg:flex justify-between">
                                                        <div className="col-lg-12">

                                                            <p className="lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw]  text-[#212833] ">Absolutely! Our plans are scalable. As your business grows, you can add additional services like tax filing, advanced reporting, and more to meet your evolving needs.
                                                            </p>
